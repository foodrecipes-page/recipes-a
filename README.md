...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'a'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-a@main/recipes/<cuisine>/<diet>/<slug>.json
```
